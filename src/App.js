  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/moviesList' element={<ListMovie movies={movies} setMovies={setMovies} search={search} rate={rate} validRate={validRate} setSearch={setSearch} setRate={setRate} setValidRate={setValidRate}/>}/>
        <Route path='/description/:djeja' element={<DescMovie movies={movies}/>}/>
      </Routes>
    </div>
  );
}
